...
One Independent Democrat. Not sure what to do with this one, so skipping
it.
...
Three missing. All created and added to config.json
...
Then sent to QuickStatements as https://editgroups.toolforge.org/b/QSv2T/1598095276548/
